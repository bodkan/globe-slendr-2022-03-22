...
Test for the evidence of Neanderthal introgression in Europeans using an $f_4$-statistic implemented in a tree-sequence function `ts_f4()` (ABBA/BABA test, Patterson's $D$ statistic) .
