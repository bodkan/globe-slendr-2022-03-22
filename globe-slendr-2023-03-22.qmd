...
## Mutations added on branches *after*!
...
::: aside
Hint: You can compute Neanderthal ancestry for a vector of individuals `X` as `ts_f4ratio(ts, X = X, "NEA_1", "NEA_2", "AFR_1", "CHIMP_1")` ("direct f4-ratio" from [Petr _et al_., PNAS 2019](https://www.pnas.org/doi/abs/10.1073/pnas.1814338116)).
:::
